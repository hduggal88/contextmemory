...
2. Double-click on the installer file you downloaded.  
3. If a security prompt asks for permission, choose **Yes** or **Run**.  
4. Follow the installation steps by clicking **Next** on each screen.  
5. Choose the default options unless you have a specific reason to change them.  
6. Click **Install** when ready.  
...
| Command               | Description                                |
|-----------------------|--------------------------------------------|
| `contextmemory save`      | Save your current coding and AI context    |
| `contextmemory restore`   | Restore last saved session                  |
| `contextmemory list`      | List all saved sessions                      |
| `contextmemory delete [name]` | Remove a saved session by name               |
| `contextmemory help`      | Show all available commands                  |
